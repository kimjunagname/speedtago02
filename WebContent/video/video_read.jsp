		...
		<!-- 왼쪽 사이트 바 시작 [범위: 2]----------------------------------------------------- -->
			...
			<div class="col-10  col-12-narrower imp-narrower">
					<div id="content">
						...
						<div align="center">
							<img src="/speedtago/images/video_imgsample.PNG" width="700px">
						</div>
						<br>
						<br>
						...
						<ul class='right' align="center">
							<a href="<%=root%>/Video.jsp"><button type="button">목록가기</button></a>
							<a href="<%=root%>/video_modify.jsp"><button type="button">수정</button></a>
