...
function moveWrite() {
	...
	alert("modify.jsp >>>> 글이 수정되었습니다. ");
	alert("modify.jsp 현재 seq >>>> " +"${article.seq}");
	alert("modify.jsp 현재 subject >>>> " +"${article.subject}");
	alert("modify.jsp 현재 content >>>> " +"${article.content}");
...
<table border="0" cellpadding="5" cellspacing="0" width="630"
	...
	<tr valign="top">
		...
		<b>제목</b></td>
		<td colspan="5">
		<input name="subject" id="subject" value="${article.subject }" type="text" size="76" maxlength="150" class="inp_02" style="width: 300px" value="">
		<img src="${root}/img/board/i_info.gif" width="12" height="11" border="0" align="absmiddle" vspace="8" style="margin: 3 3 0 6"><font class="stext">최대 한글 75자,
		영문 150자</font><br>
	</tr>
	...
	<tr>
		...
		<b>글내용</b>
		<textarea  id="content" name="content" class="inp_02"  cols="67" rows="25" scrollbars="no">${article.content}</textarea>
...
<table border="0" cellpadding="2" cellspacing="0" width="630">
	...
	<tr>
		...
		<img src="${root}/img/board/btn_register.gif"  width="42" height="21" border="0" name="register" alt="등록"></a>
		<a href="javascript:history.back();">
		<img src="${root}/img/board/b_cancel.gif" width="42" height="21" border="0" name="cencel" alt="취소"></a>
		</td>
	</tr>
</table>
</form>
