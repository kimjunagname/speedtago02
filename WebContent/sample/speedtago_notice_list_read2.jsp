				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="box post">
							...
							<a href="images/tu005.jpg" class="image left"><img
								src="images/tu005.jpg" alt="" /></a>
							<div class="inner">
								<p>공지사항 1호 입니다.</p>
							</div>
						</div>
						...
						<ul class='right' align="center">
							<button type="button"
								onclick="location.href='speedtago_notice_list.jsp'">목록가기</button>
							<button type="button"
								onclick="location.href='speedtago_notice_list_modfiy_write.jsp'">수정</button>
							<button type="button"
